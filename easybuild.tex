...
\begin{itemize}
    \item downloading, unpacking, patching of sources;
    \item loading module files for dependencies;
    \item setting up the build enviroment, i.e, defining environment variables
    like \texttt{\small\$CC},
    \texttt{\small\$CXXFLAGS}, etc.;
    \item running shell commands (e.g., \texttt{\small make}), including running
...
Recent releases of \easybuild{} include out-of-the-box support for: various
