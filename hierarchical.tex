...
compatible with the user's new lower-level selections''?}
We strongly believe
...
to the user until its higher-level \markus{Likewise ``lower-level''} modules are loaded.  This
...
lower-level \markus{higher-level} module is available. Unless the modules tool deals with this issue
