...
way. The key idea is to make module files available in a step-by-step fashion as their dependencies become part of the user environment.  Initially only a small number of so-called \emph{core} modules are
...
compilers themselves, and statically linked software like debuggers.
