Lmod~\cite{laytonLmod,taccSecretSauce,taccLmod} is a Lua-based~\cite{LuaBook}, modern alternative to
...
For example, using the available hook for the \texttt{\small load} subcommand, a site can add a new accompanying action. A typical example is a message logger: by adding this action to the \texttt{\small load} subcommand, a site can collect and analyze module usage across the entire system.
...
One final feature of Lmod is worth mentioning: support for user-defined
