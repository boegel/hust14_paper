...
\remark{module files are shell-independent}
...
\remark{flat naming scheme (most common?), categorized as first attempt to better structure things}

\subsubsection{Modules tool}

\kenneth{I feel like a more general explenation of what a modules tool does for the user is missing here}
...
\remark{missing reference for the DEISA variant of modulecmd.tcl}
