...
Some sites (ab)use configuration management tools like Puppet or Chef to manage
...
with a workflow that is manageable, by lack of a better alternative.
...
Section~\ref{sec:related_work}. Generally this concerns tools which were
developed in-house over the years, after having started as yet another bunch of
...
lack of production usage across different HPC sites (for whatever reason),
inadequate flexibility and features, missing support funds to keep development
active, etc.
